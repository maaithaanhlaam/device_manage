...
?>
    <form action="index.php?act=tracuu&ma=<?php echo $ma?> " method="post">
        ...
        <input class="submit" type="submit" value="Tìm" name="tim">
    </form>
    <h2>
            ...
            <tr class="">
                ...
                <td ><div class="box">
                    ...
                    <div id="popup1&maphong=<?php echo $each['id_phong']?>" class="overlay">
                        <div class="popup">
                            <form action="index.php?act=dkmuonphong&maphong=<?php echo $each['id_phong']?>" method="post" >
                                ...
                                <?php }
                                    ...
                                    <input type="checkbox"  name="sang" value="1">buổi sáng
                                <?php }
                                ?>
                                <?php if ($each['chieu'] == 1){?>
                                ...
                                <?php }
                                    ...
                                    <input type="checkbox" name="chieu" value="1" >buổi chiều
                                <?php }
                                ?>
